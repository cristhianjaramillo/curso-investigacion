# Curso de Actualización en Métodos y Técnicas de Investigación
...
```
git clone [https://github.com/usuario/estadistica-politica-2.git](https://github.com/cristhianjaramillo/curso-investigacion.git)
```
